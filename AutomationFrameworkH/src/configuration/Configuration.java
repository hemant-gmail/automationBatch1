...
public class Configuration {
	...
	public static final String edgeDriverPath = System.getProperty("user.dir") +  "\\BrowserDrivers\\msedgedriver.exe";
	public static final String testDataPath = System.getProperty("user.dir") + "\\src\\testData\\testData.xlsx";
	public static final String ScreenShortPath = System.getProperty("user.dir") +"\\Screenshots\\";
}
