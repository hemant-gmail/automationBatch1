...
public class TC_HomePage_Validation extends Driver{
	...
	public void afterMethod(ITestResult result){
		if(ITestResult.FAILURE==result.getStatus()){
			try {
				lib.capureScreenShot(wdr, result.getName());
				System.out.println("Successfuly captured screen shot");
			} catch (Exception e) {
				System.out.println("Excepaiton while taking screen shor"+ e.getMessage());
				Assert.fail("Excepaiton while taking screen shor"+ e.getMessage());
			}
		}
	}
